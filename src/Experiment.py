...
class Experiment():
    ...
    def detectSpikes(self, threshold=0.0, refractory=3.0):
        ...
        print "Detect spikes (numbajit)!"
        self.spikeDetection_threshold = threshold
        self.spikeDetection_ref = refractory
    ...
    def plotTrainingSet(self):
        ...
        for tr in self.trainingset_traces :
            ...
            if tr.spks_flag :
                plt.plot(tr.getSpikeTimes(),
                    self.spikeDetection_threshold*np.ones(tr.getSpikeNb()), '.', color='red')
